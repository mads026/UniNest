...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">UniNest</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To UniNest</div>
          <div class="intro-heading text-uppercase">Find A better Room as Per your comfort<br></div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Make a quick search across a abundant rooms.</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" id="keywords" name="keywords" type="text" placeholder="Keywords Ex: Room Type, Rent Amount, Landmark" required data-validation-required-message="Please enter keywords">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <input class="form-control" id="location" type="text" name="location" placeholder="Locality" required data-validation-required-message="Please enter location.">
                    <p class="help-block text-danger"></p>
                  </div>
                </div>         
                        ...
                        <div class="card-block">';
                         ...
                         echo   '<div class="row">
                            ...
                            <h4 class="text-center">Owner Details</h4>';
                              ...
                              echo '<p><b>Aadhar Number: </b>'.$value['alternat_mobile'].'</p>';
                              echo '<p><b>Email: </b>'.$value['email'].'</p>';
                              echo '<p><b> State: </b>'.$value['state'].'</p><p><b> City: </b>'.$value['city'].'</p>';
    ...
    <!-- Footer -->
    <footer style="background-color: #AF2655;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">&copy; UniNest - <?php echo date("Y"); ?></span>
          </div>
          <div class="col-md-4">
